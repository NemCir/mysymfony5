 ...
 */
final class Version20210402181345 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__comment AS SELECT id, city_id, text, insert_date, modified_date FROM comment');
        ...
        $this->addSql('INSERT INTO comment (id, city_id, text, insert_date, modified_date) SELECT id, city_id, text, insert_date, modified_date FROM __temp__comment');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__comment AS SELECT id, city_id, text, insert_date, modified_date FROM comment');
        $this->addSql('DROP TABLE comment');
        $this->addSql('CREATE TABLE comment (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, city_id INTEGER NOT NULL, text CLOB NOT NULL, insert_date DATETIME NOT NULL, modified_date DATETIME DEFAULT NULL)');
        $this->addSql('INSERT INTO comment (id, city_id, text, insert_date, modified_date) SELECT id, city_id, text, insert_date, modified_date FROM __temp__comment');
        $this->addSql('DROP TABLE __temp__comment');
        $this->addSql('CREATE INDEX IDX_9474526C8BAC62AF ON comment (city_id)');
    }
