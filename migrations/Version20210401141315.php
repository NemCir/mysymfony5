 ...
 */
final class Version20210401141315 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE client (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, username VARCHAR(50) NOT NULL, password VARCHAR(256) NOT NULL, salt VARCHAR(16) NOT NULL, role INTEGER NOT NULL)');
