 ...
 */
final class Version20210403185256 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__route AS SELECT id, airline, airline_id, source_airport, source_airport_id, destination_airport, destination_airport_id, codeshare, stops, price, equipment FROM route');
        $this->addSql('DROP TABLE route');
        $this->addSql('CREATE TABLE route (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, airline VARCHAR(3) NOT NULL COLLATE BINARY, airline_id INTEGER NOT NULL, source_airport VARCHAR(4) NOT NULL COLLATE BINARY, source_airport_id INTEGER NOT NULL, destination_airport VARCHAR(4) NOT NULL COLLATE BINARY, destination_airport_id INTEGER NOT NULL, codeshare VARCHAR(1) DEFAULT NULL COLLATE BINARY, stops INTEGER NOT NULL, price NUMERIC(11, 2) NOT NULL, equipment VARCHAR(50) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO route (id, airline, airline_id, source_airport, source_airport_id, destination_airport, destination_airport_id, codeshare, stops, price, equipment) SELECT id, airline, airline_id, source_airport, source_airport_id, destination_airport, destination_airport_id, codeshare, stops, price, equipment FROM __temp__route');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_9474526C8BAC62AF ON comment (city_id)');
        $this->addSql('CREATE INDEX IDX_9474526CDC2902E0 ON comment (client_id_id)');
        $this->addSql('ALTER TABLE route ADD COLUMN unique_route_code VARCHAR(15) NOT NULL COLLATE BINARY');
    }
}
